...
NOV5 <- subset(df1, df1[, "A4"] == 0 & df1[, "Nov5"] == 1 &
df1[, "Nov27"] == 0 & df1[, "Nov71"] == 0 & df1[, "Bc16"] == 0 &
df1[, "Nov9"] == 0 & df1[, "Bc1"] == 0)
BC1 <- subset(df1, df1[, "A4"] == 0 & df1[, "Nov5"] == 0 &
df1[, "Nov27"] == 0 & df1[, "Nov71"] == 0 & df1[, "Bc16"] == 0 &
df1[, "Nov9"] == 0 & df1[, "Bc1"] == 1)
...
df1[, "Nov27"] != 0 & df1[, "Nov71"] != 0 & df1[, "Bc16"] != 0 &
df1[, "Nov9"] != 0 & df1[, "Bc1"] == 1))
n12 <- n123 + nrow(subset(df1, df1[, "A4"] == 0 & df1[, "Nov5"] == 1 &
df1[, "Nov27"] == 0 & df1[, "Nov71"] == 0 & df1[, "Bc16"] == 0 &
df1[, "Nov9"] == 0 & df1[, "Bc1"] == 1))
n13 <- n123 + nrow(subset(df1, df1[, "A4"] != 0 & df1[, "Nov5"] == 1 &
df1[, "Nov27"] != 0 & df1[, "Nov71"] != 0 & df1[, "Bc16"] != 0 &
df1[, "Nov9"] != 0 & df1[, "Bc1"] == 0))
