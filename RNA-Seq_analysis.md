...
data[data=="Bc16_mycelium"] <- "BC-16 mycelium"
data[data=="TA.07"] <- "TA-07"
data[data=="TA.08"] <- "TA-08"
data[data=="TA.09"] <- "TA-09"
data[data=="TA.12"] <- "TA-12"
data[data=="TA.13"] <- "TA-13"
data[data=="TA.14"] <- "TA-14"
data[data=="TA.18"] <- "TA-18"
data[data=="TA.19"] <- "TA-19"
data[data=="TA.20"] <- "TA-20"
...
```bash
ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
inp1=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_24hr_vs_Bc16_mycelium_Sec.txt
inp2=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_48hr_vs_Bc16_mycelium_Sec.txt
inp3=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_96hr_vs_Bc16_mycelium_Sec.txt
OutDir=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_all_Sec_DEGs.tsv
$ProgDir/parse_RNA-Seq.py --input_1 $inp1 --input_2 $inp2 --input_3 $inp3 --out_dir $OutDir
```
...
```bash
ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
inp1=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_24hr_vs_Bc16_mycelium_up_Sec.txt
inp2=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_48hr_vs_Bc16_mycelium_up_Sec.txt
inp3=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_96hr_vs_Bc16_mycelium_up_Sec.txt
OutDir=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_up_Sec_DEGs.tsv
$ProgDir/parse_RNA-Seq.py --input_1 $inp1 --input_2 $inp2 --input_3 $inp3 --out_dir $OutDir
```
...
```bash
ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
inp1=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_24hr_vs_Bc16_mycelium_down_Sec.txt
inp2=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_48hr_vs_Bc16_mycelium_down_Sec.txt
inp3=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_96hr_vs_Bc16_mycelium_down_Sec.txt
OutDir=alignment/star/P.fragariae/Bc16/DeSeq/Bc16_down_Sec_DEGs.tsv
$ProgDir/parse_RNA-Seq.py --input_1 $inp1 --input_2 $inp2 --input_3 $inp3 --out_dir $OutDir
```
...
ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
WorkDir=alignment/star/P.fragariae/Bc16/DeSeq
$ProgDir/BC-16_All_DEGs_venn_diag.r --inp $WorkDir/Bc16_all_Sec_DEGs.tsv --out $WorkDir/Bc16_all_Sec_DEGs.pdf
$ProgDir/BC-16_All_DEGs_venn_diag.r --inp $WorkDir/Bc16_up_Sec_DEGs.tsv --out $WorkDir/Bc16_up_Sec_DEGs.pdf
$ProgDir/BC-16_All_DEGs_venn_diag.r --inp $WorkDir/Bc16_down_Sec_DEGs.tsv --out $WorkDir/Bc16_down_Sec_DEGs.pdf
```
...
"TA_NO_P2", "TA_NO_P3")
# Throws an X11 error but still draws the plot
...
data <- plotPCA(rld, intgroup="Group", returnData=TRUE)
rownames(data) <- c("TA-07", "TA-08", "TA-09", "TA-12", "TA-13", "TA-14",
"TA-18", "TA-19", "TA-20", "TA_BC1_P1", "TA_BC1_P2", "TA_BC1_P3", "TA_NOV9_P1",
"TA_NOV9_P2", "TA_NOV9_P3")
data$group <- as.character(data$group)
data$Group <- as.character(data$Group)
data$name <- as.character(data$name)
data[data=="Bc16_24hr"] <- "BC-16 24 hpi"
...
# Throws an X11 error but draws the plot
...
data <- plotPCA(rld, intgroup="Group", returnData=TRUE)
rownames(data) <- c("TA-07", "TA-08", "TA-09", "TA-12", "TA-13", "TA-14",
"TA-18", "TA-19", "TA-20", "TA-32", "TA-34", "TA-35", "TA_BC1_M1",
"TA_BC1_M2", "TA_BC1_M3", "TA_BC1_P1", "TA_BC1_P2", "TA_BC1_P3",
"TA_NOV9_M1", "TA_NOV9_M2", "TA_NOV9_M5", "TA_NOV9_P1", "TA_NOV9_P2",
"TA_NOV9_P3")
data$group <- as.character(data$group)
data$Group <- as.character(data$Group)
data$name <- as.character(data$name)
...
data[data=="Bc16_96hr"] <- "BC-16 96 hpi"
data[data=="Bc16_mycelium"] <- "BC-16 mycelium"
data[data=="Bc1_mycelium"] <- "BC-1 mycelium"
data[data=="Bc1_48hr"] <- "BC-1 48 hpi"
data[data=="Nov9_mycelium"] <- "NOV-9 mycelium"
data[data=="Nov9_72hr"] <- "NOV-9 72 hpi"
data$group <- as.factor(data$group)
data$Group <- as.factor(data$Group)
data$name <- as.factor(data$name)
...
colnames(rld) <- c("TA-07", "TA-08", "TA-09", "TA-12", "TA-13", "TA-14",
"TA-18", "TA-19", "TA-20", "TA-32", "TA-34", "TA-35", "TA_B_M1", "TA_B_M2",
"TA_B_M3", "TA_B_P1", "TA_B_P2", "TA_B_P3", "TA_NO_M1", "TA_NO_M2", "TA_NO_M5",
"TA_NO_P1", "TA_NO_P2", "TA_NO_P3")
...
data <- plotPCA(rld, intgroup="Group", returnData=TRUE)
rownames(data) <- c("TA-07", "TA-08", "TA-09", "TA-12", "TA-13", "TA-14",
"TA-18", "TA-19", "TA-20", "TA-32", "TA-34", "TA-35", "TA_BC1_M1", "TA_BC1_M2",
"TA_BC1_M3", "TA_BC1_P1", "TA_BC1_P2" "TA_BC1_P3", "TA_NOV9_M1", "TA_NOV9_M2",
"TA_NOV9_M5", "TA_NOV9_P1", "TA_NOV9_P2", "TA_NOV9_P3")
data$group <- as.character(data$group)
data$Group <- as.character(data$Group)
data$name <- as.character(data$name)
data[data=="Bc16_24hr"] <- "BC-16 24 hpi"
...
colnames(rld) <- c("TA-07", "TA-08", "TA-09", "TA-12", "TA-13", "TA-14",
"TA-18", "TA-19", "TA-20", "TA-32", "TA-34", "TA-35", "TA_B_M1", "TA_B_M2",
"TA_B_M3", "TA_B_P1", "TA_B_P2", "TA_B_P3", "TA_NO_M1", "TA_NO_M2",
"TA_NO_M5", "TA_NO_P1", "TA_NO_P2", "TA_NO_P3")
...
### Make initial annotation table for BC-16
...
## Parse DEG results for method 2 to ensure thresholding correct
...
do
    ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
    inp1=analysis/DeSeq/Method_2/$Isolate/Bc16_24hr_vs_Bc16_mycelium.txt
    inp2=analysis/DeSeq/Method_2/$Isolate/Bc16_48hr_vs_Bc16_mycelium.txt
    inp3=analysis/DeSeq/Method_2/$Isolate/Bc16_96hr_vs_Bc16_mycelium.txt
    OutDir=analysis/DeSeq/Method_2/$Isolate/Bc16_vs_Bc16_mycelium.tsv
    $ProgDir/parse_RNA-Seq.py --input_1 $inp1 --input_2 $inp2 --input_3 $inp3 --out_dir $OutDir
done
```
...
do
    ...
    do
        ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
        inp1=$(ls analysis/DeSeq/Method_2/$Reference/"$Isolate"_*_vs_"$Isolate"_mycelium.txt)
        OutDir=analysis/DeSeq/Method_2/$Reference/"$Isolate"_vs_"$Isolate"_mycelium.tsv
