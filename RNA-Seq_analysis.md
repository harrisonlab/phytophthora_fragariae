...
do
    ...
    DEG_Files=$(ls alignment/star/P.fragariae/Bc16/DeSeq/*_vs_*.txt  | grep -v -e 'up' -e 'down' -e "CRN" -e "RxLR" -e "ApoP" | sed -e "s/$/ /g" | tr -d "\n")
...
#load tables into a "list of lists"
qq <- lapply(list.files("analysis/DeSeq/Method_3/Bc1","*featurecounts.txt$",full.names=T,recursive=T),function(x) fread(x))
...
#output countData
write.table(countData,"analysis/DeSeq/Method_3/Bc1/Bc1_countData.txt",sep="\t",na="",quote=F)

#output gene details
write.table(m[,1:6,with=F],"analysis/DeSeq/Method_3/Bc1/Bc1_genes.txt",sep="\t",quote=F,row.names=F)

#Running DeSeq2

require("DESeq2")

unorderedColData <- read.table("analysis/DeSeq/Method_3/Bc1/P.frag_method3_Bc1_RNAseq_design.txt",header=T,sep="\t")
rownames(unorderedColData) <- unorderedColData$Sample.name
unorderedColDataSubset <- unorderedColData[indexes,]

colData <- data.frame(unorderedColDataSubset[ order(unorderedColDataSubset$Sample.name),])
unorderedData <- read.table("analysis/DeSeq/Method_3/Bc1/Bc1_countData.txt",header=T,sep="\t")
countData <- data.frame(unorderedData[ , order(colnames(unorderedData))])
colData$Group <- paste0(colData$Isolate,'_', colData$Timepoint)
countData <- round(countData,0)
...
pdf("analysis/DeSeq/Method_3/Bc1/heatmap_vst.pdf", width=12,height=12)
sampleDists<-dist(t(assay(vst)))
...
pdf("analysis/DeSeq/Method_3/Bc1/heatmap_rld.pdf")
sampleDists <- dist( t( assay(rld) ) )
library("RColorBrewer")
sampleDistMatrix <- as.matrix( sampleDists )
rownames(sampleDistMatrix) <- paste(rld$Group)
...
pdf("analysis/DeSeq/Method_3/Bc1/PCA_vst.pdf")
plotPCA(vst,intgroup=c("Isolate", "Timepoint"))
dev.off()

#Plot using rlog transformation:
pdf("analysis/DeSeq/Method_3/Bc1/PCA_rld.pdf")
plotPCA(rld,intgroup=c("Isolate", "Timepoint"))
dev.off()

pdf("analysis/DeSeq/Method_3/Bc1/PCA_additional.pdf")
...
ggsave("analysis/DeSeq/Method_3/Bc1/PCA_sample_names.pdf", pca_plot, dpi=300, height=10, width=12)
...
write.table(sig.res,"analysis/DeSeq/Method_3/Bc1/Bc1_48hr_vs_Bc1_mycelium.txt",sep="\t",na="",quote=F)
write.table(sig.res.upregulated,"analysis/DeSeq/Method_3/Bc1/Bc1_48hr_vs_Bc1_mycelium_up.txt",sep="\t",na="",quote=F)
write.table(sig.res.downregulated,"analysis/DeSeq/Method_3/Bc1/Bc1_48hr_vs_Bc1_mycelium_down.txt",sep="\t",na="",quote=F)

#Make a table of raw counts, normalised counts and fpkm values:

raw_counts <- data.frame(counts(dds, normalized=FALSE))
colnames(raw_counts) <- paste(colData$Group)
write.table(raw_counts,"analysis/DeSeq/Method_3/Bc1/raw_counts.txt",sep="\t",na="",quote=F)
norm_counts <- data.frame(counts(dds, normalized=TRUE))
colnames(norm_counts) <- paste(colData$Group)
write.table(norm_counts,"analysis/DeSeq/Method_3/Bc1/normalised_counts.txt",sep="\t",na="",quote=F)
...
fpkm_counts <- data.frame(fpkm(dds, robust = TRUE))
colnames(fpkm_counts) <- paste(colData$Group)
write.table(fpkm_counts,"analysis/DeSeq/Method_3/Bc1/fpkm_norm_counts.txt",sep="\t",na="",quote=F)
fpkm_counts <- data.frame(fpkm(dds, robust = FALSE))
colnames(fpkm_counts) <- paste(colData$Group)
write.table(fpkm_counts,"analysis/DeSeq/Method_3/Bc1/fpkm_counts.txt",sep="\t",na="",quote=F)
```
...
#load tables into a "list of lists"
qq <- lapply(list.files("analysis/DeSeq/Method_3/Bc16","*featurecounts.txt$",full.names=T,recursive=T),function(x) fread(x))
...
#output countData
write.table(countData,"analysis/DeSeq/Method_3/Bc16/Bc16_countData.txt",sep="\t",na="",quote=F)

#output gene details
write.table(m[,1:6,with=F],"analysis/DeSeq/Method_3/Bc16/Bc16_genes.txt",sep="\t",quote=F,row.names=F)

#Running DeSeq2

require("DESeq2")

unorderedColData <- read.table("analysis/DeSeq/Method_3/Bc16/P.frag_method3_Bc16_RNAseq_design.txt",header=T,sep="\t")
rownames(unorderedColData) <- unorderedColData$Sample.name
unorderedColDataSubset <- unorderedColData[indexes,]

colData <- data.frame(unorderedColDataSubset[ order(unorderedColDataSubset$Sample.name),])
unorderedData <- read.table("analysis/DeSeq/Method_3/Bc16/Bc16_countData.txt",header=T,sep="\t")
countData <- data.frame(unorderedData[ , order(colnames(unorderedData))])
colData$Group <- paste0(colData$Isolate,'_', colData$Timepoint)
countData <- round(countData,0)
...
pdf("analysis/DeSeq/Method_3/Bc16/heatmap_vst.pdf", width=12,height=12)
sampleDists<-dist(t(assay(vst)))
...
pdf("analysis/DeSeq/Method_3/Bc16/heatmap_rld.pdf")
sampleDists <- dist( t( assay(rld) ) )
library("RColorBrewer")
sampleDistMatrix <- as.matrix( sampleDists )
rownames(sampleDistMatrix) <- paste(rld$Group)
...
pdf("analysis/DeSeq/Method_3/Bc16/PCA_vst.pdf")
plotPCA(vst,intgroup=c("Isolate", "Timepoint"))
dev.off()

#Plot using rlog transformation:
pdf("analysis/DeSeq/Method_3/Bc16/PCA_rld.pdf")
plotPCA(rld,intgroup=c("Isolate", "Timepoint"))
dev.off()

pdf("analysis/DeSeq/Method_3/Bc16/PCA_additional.pdf")
...
ggsave("analysis/DeSeq/Method_3/Bc16/PCA_sample_names.pdf", pca_plot, dpi=300, height=10, width=12)
...
write.table(sig.res,"analysis/DeSeq/Method_3/Bc16/Bc16_24hr_vs_Bc16_mycelium.txt",sep="\t",na="",quote=F)
write.table(sig.res.upregulated,"analysis/DeSeq/Method_3/Bc16/Bc16_24hr_vs_Bc16_mycelium_up.txt",sep="\t",na="",quote=F)
write.table(sig.res.downregulated,"analysis/DeSeq/Method_3/Bc16/Bc16_24hr_vs_Bc16_mycelium_down.txt",sep="\t",na="",quote=F)
...
write.table(sig.res,"analysis/DeSeq/Method_3/Bc16/Bc16_48hr_vs_Bc16_mycelium.txt",sep="\t",na="",quote=F)
write.table(sig.res.upregulated,"analysis/DeSeq/Method_3/Bc16/Bc16_48hr_vs_Bc16_mycelium_up.txt",sep="\t",na="",quote=F)
write.table(sig.res.downregulated,"analysis/DeSeq/Method_3/Bc16/Bc16_48hr_vs_Bc16_mycelium_down.txt",sep="\t",na="",quote=F)
...
write.table(sig.res,"analysis/DeSeq/Method_3/Bc16/Bc16_96hr_vs_Bc16_mycelium.txt",sep="\t",na="",quote=F)
write.table(sig.res.upregulated,"analysis/DeSeq/Method_3/Bc16/Bc16_96hr_vs_Bc16_mycelium_up.txt",sep="\t",na="",quote=F)
write.table(sig.res.downregulated,"analysis/DeSeq/Method_3/Bc16/Bc16_96hr_vs_Bc16_mycelium_down.txt",sep="\t",na="",quote=F)

#Make a table of raw counts, normalised counts and fpkm values:

raw_counts <- data.frame(counts(dds, normalized=FALSE))
colnames(raw_counts) <- paste(colData$Group)
write.table(raw_counts,"analysis/DeSeq/Method_3/Bc16/raw_counts.txt",sep="\t",na="",quote=F)
norm_counts <- data.frame(counts(dds, normalized=TRUE))
colnames(norm_counts) <- paste(colData$Group)
write.table(norm_counts,"analysis/DeSeq/Method_3/Bc16/normalised_counts.txt",sep="\t",na="",quote=F)
...
fpkm_counts <- data.frame(fpkm(dds, robust = TRUE))
colnames(fpkm_counts) <- paste(colData$Group)
write.table(fpkm_counts,"analysis/DeSeq/Method_3/Bc16/fpkm_norm_counts.txt",sep="\t",na="",quote=F)
fpkm_counts <- data.frame(fpkm(dds, robust = FALSE))
colnames(fpkm_counts) <- paste(colData$Group)
write.table(fpkm_counts,"analysis/DeSeq/Method_3/Bc16/fpkm_counts.txt",sep="\t",na="",quote=F)
```
...
#load tables into a "list of lists"
qq <- lapply(list.files("analysis/DeSeq/Method_3/Nov9","*featurecounts.txt$",full.names=T,recursive=T),function(x) fread(x))
...
#output countData
write.table(countData,"analysis/DeSeq/Method_3/Nov9/Nov9_countData.txt",sep="\t",na="",quote=F)

#output gene details
write.table(m[,1:6,with=F],"analysis/DeSeq/Method_3/Nov9/Nov9_genes.txt",sep="\t",quote=F,row.names=F)

#Running DeSeq2

require("DESeq2")

unorderedColData <- read.table("analysis/DeSeq/Method_3/Nov9/P.frag_method3_Nov9_RNAseq_design.txt",header=T,sep="\t")
rownames(unorderedColData) <- unorderedColData$Sample.name
unorderedColDataSubset <- unorderedColData[indexes,]

colData <- data.frame(unorderedColDataSubset[ order(unorderedColDataSubset$Sample.name),])
unorderedData <- read.table("analysis/DeSeq/Method_3/Nov9/Nov9_countData.txt",header=T,sep="\t")
countData <- data.frame(unorderedData[ , order(colnames(unorderedData))])
colData$Group <- paste0(colData$Isolate,'_', colData$Timepoint)
countData <- round(countData,0)
...
pdf("analysis/DeSeq/Method_3/Nov9/heatmap_vst.pdf", width=12,height=12)
sampleDists<-dist(t(assay(vst)))
...
pdf("analysis/DeSeq/Method_3/Nov9/heatmap_rld.pdf")
sampleDists <- dist( t( assay(rld) ) )
library("RColorBrewer")
sampleDistMatrix <- as.matrix( sampleDists )
rownames(sampleDistMatrix) <- paste(rld$Group)
...
pdf("analysis/DeSeq/Method_3/Nov9/PCA_vst.pdf")
plotPCA(vst,intgroup=c("Isolate", "Timepoint"))
dev.off()

#Plot using rlog transformation:
pdf("analysis/DeSeq/Method_3/Nov9/PCA_rld.pdf")
plotPCA(rld,intgroup=c("Isolate", "Timepoint"))
dev.off()

pdf("analysis/DeSeq/Method_3/Nov9/PCA_additional.pdf")
...
ggsave("analysis/DeSeq/Method_3/Nov9/PCA_sample_names.pdf", pca_plot, dpi=300, height=10, width=12)
...
write.table(sig.res,"analysis/DeSeq/Method_3/Nov9/Nov9_72hr_vs_Nov9_mycelium.txt",sep="\t",na="",quote=F)
write.table(sig.res.upregulated,"analysis/DeSeq/Method_3/Nov9/Nov9_72hr_vs_Nov9_mycelium_up.txt",sep="\t",na="",quote=F)
write.table(sig.res.downregulated,"analysis/DeSeq/Method_3/Nov9/Nov9_72hr_vs_Nov9_mycelium_down.txt",sep="\t",na="",quote=F)

#Make a table of raw counts, normalised counts and fpkm values:

raw_counts <- data.frame(counts(dds, normalized=FALSE))
colnames(raw_counts) <- paste(colData$Group)
write.table(raw_counts,"analysis/DeSeq/Method_3/Nov9/raw_counts.txt",sep="\t",na="",quote=F)
norm_counts <- data.frame(counts(dds, normalized=TRUE))
colnames(norm_counts) <- paste(colData$Group)
write.table(norm_counts,"analysis/DeSeq/Method_3/Nov9/normalised_counts.txt",sep="\t",na="",quote=F)
...
fpkm_counts <- data.frame(fpkm(dds, robust = TRUE))
colnames(fpkm_counts) <- paste(colData$Group)
write.table(fpkm_counts,"analysis/DeSeq/Method_3/Nov9/fpkm_norm_counts.txt",sep="\t",na="",quote=F)
fpkm_counts <- data.frame(fpkm(dds, robust = FALSE))
colnames(fpkm_counts) <- paste(colData$Group)
