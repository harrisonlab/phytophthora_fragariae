...
mv C101HW17030405/raw_data/TA_NO_P1_1.fq.gz P.fragariae/Nov9/48hr/F/.
mv C101HW17030405/raw_data/TA_NO_P2_1.fq.gz P.fragariae/Nov9/48hr/F/.
mv C101HW17030405/raw_data/TA_NO_P3_1.fq.gz P.fragariae/Nov9/48hr/F/.
...
mv C101HW17030405/raw_data/TA_NO_P1_2.fq.gz P.fragariae/Nov9/48hr/R/.
mv C101HW17030405/raw_data/TA_NO_P2_2.fq.gz P.fragariae/Nov9/48hr/R/.
mv C101HW17030405/raw_data/TA_NO_P3_2.fq.gz P.fragariae/Nov9/48hr/R/.
...
colData <- data.frame(unorderedColDataSubset[ order(unorderedColDataSubset$Sample.name),])
unorderedData <- read.table("alignment/star/P.fragariae/Bc1/DeSeq/No_Mock_countData.txt",header=T,sep="\t")
countData <- data.frame(unorderedData[ , order(colnames(unorderedData))])
colData$Group <- paste0(colData$Isolate,'_', colData$Timepoint)
countData <- round(countData,0)
...
do
    ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
    inp1=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_24hr_vs_"$Strain"_mycelium_up.txt
    inp2=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_48hr_vs_"$Strain"_mycelium_up.txt
    inp3=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_96hr_vs_"$Strain"_mycelium_up.txt
    OutDir=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_up_DEGs.tsv
    $ProgDir/parse_RNA-Seq.py --input_1 $inp1 --input_2 $inp2 --input_3 $inp3 --out_dir $OutDir
done
```
...
do
    ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
    inp1=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_24hr_vs_"$Strain"_mycelium_RxLRs.txt
    inp2=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_48hr_vs_"$Strain"_mycelium_RxLRs.txt
    inp3=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_96hr_vs_"$Strain"_mycelium_RxLRs.txt
    OutDir=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_all_RxLRs_DEGs.tsv
    $ProgDir/parse_RNA-Seq.py --input_1 $inp1 --input_2 $inp2 --input_3 $inp3 --out_dir $OutDir
done
```
...
do
    ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
    inp1=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_24hr_vs_"$Strain"_mycelium_CRNs.txt
    inp2=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_48hr_vs_"$Strain"_mycelium_CRNs.txt
    inp3=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_96hr_vs_"$Strain"_mycelium_CRNs.txt
    OutDir=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_all_CRNs_DEGs.tsv
    $ProgDir/parse_RNA-Seq.py --input_1 $inp1 --input_2 $inp2 --input_3 $inp3 --out_dir $OutDir
done
```
...
do
    ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
    inp1=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_24hr_vs_"$Strain"_mycelium_up_CRNs.txt
    inp2=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_48hr_vs_"$Strain"_mycelium_up_CRNs.txt
    inp3=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_96hr_vs_"$Strain"_mycelium_up_CRNs.txt
    OutDir=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_up_CRNs_DEGs.tsv
    $ProgDir/parse_RNA-Seq.py --input_1 $inp1 --input_2 $inp2 --input_3 $inp3 --out_dir $OutDir
done
```
...
do
    ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
    inp1=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_24hr_vs_"$Strain"_mycelium_down_CRNs.txt
    inp2=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_48hr_vs_"$Strain"_mycelium_down_CRNs.txt
    inp3=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_96hr_vs_"$Strain"_mycelium_down_CRNs.txt
    OutDir=alignment/star/P.fragariae/$Strain/DeSeq/"$Strain"_down_CRNs_DEGs.tsv
    $ProgDir/parse_RNA-Seq.py --input_1 $inp1 --input_2 $inp2 --input_3 $inp3 --out_dir $OutDir
done
```
...
do
    ProgDir=/home/adamst/git_repos/scripts/phytophthora_fragariae
    WorkDir=alignment/star/P.fragariae/$Strain/DeSeq
    $ProgDir/BC-16_All_DEGs_venn_diag.r --inp $WorkDir/"$Strain"_all_CRNs_DEGs.tsv --out $WorkDir/"$Strain"_all_CRNs_DEGs.pdf
    $ProgDir/BC-16_All_DEGs_venn_diag.r --inp $WorkDir/"$Strain"_up_CRNs_DEGs.tsv --out $WorkDir/"$Strain"_up_CRNs_DEGs.pdf
    $ProgDir/BC-16_All_DEGs_venn_diag.r --inp $WorkDir/"$Strain"_down_CRNs_DEGs.tsv --out $WorkDir/"$Strain"_down_CRNs_DEGs.pdf
done
```
