...
TP1=subset(df1, df1[,"24hr"] == 1 & df1[,"48hr"] == 0 & df1[,"96hr"] == 0)
...
n12=n123 + nrow(subset(df1, df1[,"24hr"] == 1 & df1[,"48hr"] == 1 & df1[,"96hr"] == 0))
n13=n123 + nrow(subset(df1, df1[,"24hr"] == 1 & df1[,"48hr"] == 0 & df1[,"96hr"] == 1))
n23=n123 + nrow(subset(df1, df1[,"24hr"] == 0 & df1[,"48hr"] == 1 & df1[,"96hr"] == 1))
summary(n12)
summary(n13)
summary(n23)
summary(n123)
