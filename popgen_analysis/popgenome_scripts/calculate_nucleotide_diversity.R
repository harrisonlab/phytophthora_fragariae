...
CA4 <- c("ONT3_1", "ONT3_2")
CA5 <- c("Bc23_1", "Bc23_2")
UN <- c("SCRP245_v2_1", "SCRP245_v2_2")s
...
write.table(Pi_table, file = file_table, sep = "\t", quote = FALSE,
col.names = FALSE)
...
write.table(Pi_persite[, i], file = slide_table, sep = "\t", quote = FALSE,
col.names = FALSE)
}
...
write.table(dxy_table, file = file_table, sep = "\t", quote = FALSE,
...
sep = "")
write.table(dxy[1, ], file = file_table, sep = "\t", quote = FALSE,
col.names = FALSE)
}
##############################################################
...
for (i in seq_along(population_names)){
  ...
  write.table(Pi_ns_persite[, i], file = slide_table, sep = "\t",
