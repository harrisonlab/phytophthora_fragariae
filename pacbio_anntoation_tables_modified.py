...
ap.add_argument('--CRN_total_ORF',required=True,type=str,help='fasta file of all transcripts considered CRNs from ORFs')
...
with open(conf.CRN_ORF_total) as f:
    CRN_orf_total_lines = f.readlines()
...
for line in transcript_lines:
    ...
    #     gpi = 'Yes'
    if any([sigP2 == 'Yes', sigP3 == 'Yes', sigP4 == 'Yes']) and all([trans_mem == '']):
        secreted = 'Yes'
    else:
        secreted = ''
    ...
    outline.extend([RxLR_total, RxLR_EER_total, CRN_total])
