...
n123=nrow(subset(DEGs, DEGs[,"XBC-16"] == 1 & DEGs[,"XBC-1"] == 1 & DEGs[,"XNOV-9"] == 1))
n12=n123 + nrow(subset(DEGs, DEGs[,"XBC-16"] == 1 & DEGs[,"XBC-1"] == 1 & DEGs[,"XNOV-9"] == 0))
n13=n123 + nrow(subset(DEGs, DEGs[,"XBC-16"] == 1 & DEGs[,"XBC-1"] == 0 & DEGs[,"XNOV-9"] == 1))
n23=n123 + nrow(subset(DEGs, DEGs[,"XBC-16"] == 0 & DEGs[,"XBC-1"] == 1 & DEGs[,"XNOV-9"] == 1))
summary(n12)
summary(n13)
summary(n23)
summary(n123)
