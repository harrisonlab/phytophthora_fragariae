...
#-----------------------------------------------------
# For each strain in each orthogroup, add the constituent genes to a set. Count the number of genes in this set and print to a table. Strain names and reshape commands need to be specified any time this script is run.
