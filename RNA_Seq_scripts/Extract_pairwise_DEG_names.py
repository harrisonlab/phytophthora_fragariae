...
for item in DEG_list:
    if item.split('/')[-1].split('_')[0] == Org1 and item.split('/')[-1].split('_')[3] == Org2 and item.split('/')[-1].split('_')[5] == "up":
    ...
    elif item.split('/')[-1].split('_')[0] == Org2 and item.split('/')[-1].split('_')[3] == Org1 and item.split('/')[-1].split('_')[5] == "down":
        transcript_id = item.split('/').split('_')[6]
        Org1_vs_Org2.append(transcript_id)
        Org1_vs_Org2_LFC[transcript_id] = LFC_values[item]
        Org1_vs_Org2_Pval[transcript_id] = P_values[item]
...
for item in DEG_list:
    if item.split('/')[-1].split('_')[0] == Org1 and item.split('/')[-1].split('_')[3] == Org3 and item.split('/')[-1].split('_')[5] == "up":
        transcript_id = item.split('/').split('_')[6]
    ...
    elif item.split('/')[-1].split('_')[0] == Org3 and item.split('/')[-1].split('_')[3] == Org1 and item.split('/')[-1].split('_')[5] == "down":
        transcript_id = item.split('/').split('_')[6]
        Org1_vs_Org3.append(transcript_id)
        Org1_vs_Org3_LFC[transcript_id] = LFC_values[item]
        Org1_vs_Org3_Pval[transcript_id] = P_values[item]
...
for item in DEG_list:
    if item.split('/')[-1].split('_')[0] == Org2 and item.split('/')[-1].split('_')[3] == Org1 and item.split('/')[-1].split('_')[5] == "up":
        transcript_id = item.split('/').split('_')[6]
    ...
    elif item.split('/')[-1].split('_')[0] == Org1 and item.split('/')[-1].split('_')[3] == Org2 and item.split('/')[-1].split('_')[5] == "down":
        transcript_id = item.split('/').split('_')[6]
        Org2_vs_Org1.append(transcript_id)
        Org2_vs_Org1_LFC[transcript_id] = LFC_values[item]
        Org2_vs_Org1_Pval[transcript_id] = P_values[item]
...
for item in DEG_list:
    if item.split('/')[-1].split('_')[0] == Org2 and item.split('/')[-1].split('_')[3] == Org3 and item.split('/')[-1].split('_')[5] == "up":
        transcript_id = item.split('/').split('_')[6]
    ...
    elif item.split('/')[-1].split('_')[0] == Org3 and item.split('/')[-1].split('_')[3] == Org2 and item.split('/')[-1].split('_')[5] == "down":
        transcript_id = item.split('/').split('_')[6]
        Org2_vs_Org3.append(transcript_id)
        Org2_vs_Org3_LFC[transcript_id] = LFC_values[item]
        Org2_vs_Org3_Pval[transcript_id] = P_values[item]
...
for item in DEG_list:
    if item.split('/')[-1].split('_')[0] == Org3 and item.split('/')[-1].split('_')[3] == Org1 and item.split('/')[-1].split('_')[5] == "up":
        transcript_id = item.split('/').split('_')[6]
    ...
    elif item.split('/')[-1].split('_')[0] == Org1 and item.split('/')[-1].split('_')[3] == Org3 and item.split('/')[-1].split('_')[5] == "down":
        transcript_id = item.split('/').split('_')[6]
        Org3_vs_Org1.append(transcript_id)
        Org3_vs_Org1_LFC[transcript_id] = LFC_values[item]
        Org3_vs_Org1_Pval[transcript_id] = P_values[item]
...
for item in DEG_list:
    if item.split('/')[-1].split('_')[0] == Org3 and item.split('/')[-1].split('_')[3] == Org2 and item.split('/')[-1].split('_')[5] == "up":
        transcript_id = item.split('/').split('_')[6]
    ...
    elif item.split('/')[-1].split('_')[0] == Org2 and item.split('/')[-1].split('_')[3] == Org3 and item.split('/')[-1].split('_')[5] == "down":
        transcript_id = item.split('/').split('_')[6]
        Org3_vs_Org2.append(transcript_id)
        Org3_vs_Org2_LFC[transcript_id] = LFC_values[item]
        Org3_vs_Org2_Pval[transcript_id] = P_values[item]
