...
```bash
for RepDir in $(ls -d repeat_masked/*/*/*)
do
...
```
P.fragariae	A4
The number of bases masked by RepeatMasker:	24,674,249
The number of bases masked by TransposonPSI:	6,237,528
The total number of masked bases are:	26,457,245
P.fragariae	Bc1
The number of bases masked by RepeatMasker:	25,009,879
The number of bases masked by TransposonPSI:	6,219,671
The total number of masked bases are:	26,840,804
P.fragariae	Bc16
...
P.fragariae	Nov5
The number of bases masked by RepeatMasker:	25,022,519
The number of bases masked by TransposonPSI:	6,242,538
The total number of masked bases are:	26,715,305
P.fragariae	Nov71
The number of bases masked by RepeatMasker:	24,197,449
The number of bases masked by TransposonPSI:	6,080,704
The total number of masked bases are:	25,938,825
P.fragariae	Nov77
...
P.fragariae	Nov9
The number of bases masked by RepeatMasker:	25,318,699
The number of bases masked by TransposonPSI:	6,290,033
The total number of masked bases are:	27,012,275
P.fragariae	ONT3
...
The number of bases masked by RepeatMasker:	24,309,623
The number of bases masked by TransposonPSI:	6,037,588
The total number of masked bases are:	26,062,283
```
...
```bash
ProgDir=/home/adamst/git_repos/tools/seq_tools/feature_annotation
for OrfGff in $(ls gene_pred/ORF_finder/P.*/*/*_ORF.gff | grep -v 'atg' | grep -v "Bc16")
do
    echo "$OrfGff"
...
Without EER:
Last login: Fri Aug  4 10:55:46 on ttys002
toms-macbook-3:~ adamst$ . ~/.bashrc
toms-macbook-3:~ adamst$ cluster_mount
...
Last login: Fri Aug  4 10:37:34 2017 from toms-macbook-3.emr.ac.uk
adamst@bio72:~$ cd /home/groups/harrisonlab/project_files/phytophthora_fragariae/
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r
There are several suitable screens on:
	18625.pts-16.bio72	(03/08/17 13:53:24)	(Detached)
	18538.pts-15.bio72	(03/08/17 13:53:11)	(Detached)
Type "screen [-d] -r [pid.]tty.host" to resume one of them.
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r 186
[detached from 18625.pts-16.bio72]
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r 185
[detached from 18538.pts-15.bio72]
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -
[detached from 7487.pts-15.bio72]
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ top -u adamst

top - 13:51:08 up 156 days, 19:30, 11 users,  load average: 0.55, 0.23, 0.13
Tasks: 435 total,   2 running, 432 sleeping,   1 stopped,   0 zombie
%Cpu(s):  6.5 us,  0.1 sy,  0.0 ni, 93.3 id,  0.0 wa,  0.0 hi,  0.0 si,  0.0 st
KiB Mem:  16463144 total,  7154476 used,  9308668 free,   138896 buffers
KiB Swap: 16777212 total,   529776 used, 16247436 free,  2963500 cached

  PID USER      PR  NI  VIRT  RES  SHR S  %CPU %MEM    TIME+  COMMAND                                                                                                                                                                                                                                                       
 7526 adamst    20   0 14132 7024  808 R   100  0.0   0:39.39 grep                                                                                                                                                                                                                                                          
 7684 adamst    20   0 37772 2340 1484 R     1  0.0   0:00.03 top                                                                                                                                                                                                                                                           
 4377 adamst    20   0 96640 1976 1044 S     0  0.0   0:00.60 sshd                                                                                                                                                                                                                                                          
 4378 adamst    20   0 12688  948  744 S     0  0.0   0:00.17 sftp-server                                                                                                                                                                                                                                                   
 4402 adamst    20   0 96504 1828  920 S     0  0.0   0:00.02 sshd                                                                                                                                                                                                                                                          
 4403 adamst    20   0 23340 6232 1816 S     0  0.0   0:00.23 bash                                                                                                                                                                                                                                                          
 4525 adamst    20   0 96504 1820  912 S     0  0.0   0:00.00 sshd                                                                                                                                                                                                                                                          
 4526 adamst    20   0 23340 6236 1816 S     0  0.0   0:00.20 bash                                                                                                                                                                                                                                                          
 7487 adamst    20   0 23548 1732  976 S     0  0.0   0:00.01 screen                                                                                                                                                                                                                                                        
 7488 adamst    20   0 21764 4540 1700 S     0  0.0   0:00.12 bash                                                                                                                                                                                                                                                          
 7525 adamst    20   0  5636  600  492 S     0  0.0   0:00.00 cat                                                                                                                                                                                                                                                           
 7618 adamst    20   0  5616  600  496 S     0  0.0   0:00.00 sleep                                                                                                                                                                                                                                                         
 7619 adamst    20   0  5616  600  496 S     0  0.0   0:00.00 sleep                                                                                                                                                                                                                                                         
12964 adamst    20   0 10960 1616 1232 S     0  0.0   0:01.38 sub_interprosca                                                                                                                                                                                                                                               
18538 adamst    20   0 23680 1836 1020 S     0  0.0   0:00.28 screen                                                                                                                                                                                                                                                        
18539 adamst    20   0 21768 4544 1700 S     0  0.0   0:00.09 bash                                                                                                                                                                                                                                                          
18625 adamst    20   0 23636 1836 1020 S     0  0.0   0:00.30 screen                                                                                                                                                                                                                                                        
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r
There are several suitable screens on:
	7487.pts-15.bio72	(04/08/17 13:50:27)	(Detached)
	18625.pts-16.bio72	(03/08/17 13:53:23)	(Detached)
	18538.pts-15.bio72	(03/08/17 13:53:10)	(Detached)
Type "screen [-d] -r [pid.]tty.host" to resume one of them.
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r
There are several suitable screens on:
	7487.pts-15.bio72	(04/08/17 13:50:27)	(Detached)
	...
	18538.pts-15.bio72	(03/08/17 13:53:10)	(Detached)
Type "screen [-d] -r [pid.]tty.host" to resume one of them.
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r 7
[detached from 7487.pts-15.bio72]
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ top -u adamst

top - 13:53:36 up 156 days, 19:33, 11 users,  load average: 0.96, 0.54, 0.27
Tasks: 435 total,   2 running, 432 sleeping,   1 stopped,   0 zombie
%Cpu(s):  2.9 us,  1.8 sy,  0.6 ni, 94.1 id,  0.4 wa,  0.0 hi,  0.2 si,  0.0 st
KiB Mem:  16463144 total,  7168612 used,  9294532 free,   139204 buffers
KiB Swap: 16777212 total,   529756 used, 16247456 free,  2984092 cached

  PID USER      PR  NI  VIRT  RES  SHR S  %CPU %MEM    TIME+  COMMAND                                                                                                                                                                                                                                                       
 7526 adamst    20   0 14824 7816  808 R    99  0.0   3:07.62 grep                                                                                                                                                                                                                                                          
 8134 adamst    20   0 37768 2216 1400 R     6  0.0   0:00.01 top                                                                                                                                                                                                                                                           
 4377 adamst    20   0 96640 1976 1044 S     0  0.0   0:00.60 sshd                                                                                                                                                                                                                                                          
 4378 adamst    20   0 12688  948  744 S     0  0.0   0:00.17 sftp-server                                                                                                                                                                                                                                                   
 4402 adamst    20   0 96504 1828  920 S     0  0.0   0:00.03 sshd                                                                                                                                                                                                                                                          
 4403 adamst    20   0 23340 6232 1816 S     0  0.0   0:00.23 bash                                                                                                                                                                                                                                                          
 4525 adamst    20   0 96504 1820  912 S     0  0.0   0:00.00 sshd                                                                                                                                                                                                                                                          
 4526 adamst    20   0 23340 6236 1816 S     0  0.0   0:00.20 bash                                                                                                                                                                                                                                                          
 7487 adamst    20   0 23548 1796 1020 S     0  0.0   0:00.02 screen                                                                                                                                                                                                                                                        
 7488 adamst    20   0 21764 4540 1700 S     0  0.0   0:00.12 bash                                                                                                                                                                                                                                                          
 7525 adamst    20   0  5636  600  492 S     0  0.0   0:00.01 cat                                                                                                                                                                                                                                                           
 8131 adamst    20   0  5616  600  496 S     0  0.0   0:00.00 sleep                                                                                                                                                                                                                                                         
 8132 adamst    20   0  5616  596  496 S     0  0.0   0:00.00 sleep                                                                                                                                                                                                                                                         
12964 adamst    20   0 10960 1616 1232 S     0  0.0   0:01.38 sub_interprosca                                                                                                                                                                                                                                               
18538 adamst    20   0 23680 1836 1020 S     0  0.0   0:00.28 screen                                                                                                                                                                                                                                                        
18539 adamst    20   0 21768 4544 1700 S     0  0.0   0:00.09 bash                                                                                                                                                                                                                                                          
18625 adamst    20   0 23636 1836 1020 S     0  0.0   0:00.30 screen                                                                                                                                                                                                                                                        
...
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r 7
[detached from 7487.pts-15.bio72]
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ less rep
rep: No such file or directory
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ less report.txt
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r 7
[detached from 7487.pts-15.bio72]
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ less gene_pred/annotation/
._.DS_Store  .DS_Store    P.fragariae/
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ less gene_pred/annotation/P.fragariae/
A4/          Bc1/         Bc16/        Bc23/        ._.DS_Store  .DS_Store    Nov27/       Nov5/        Nov71/       Nov77/       Nov9/        ONT3/        SCRP245_v2/  
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ less gene_pred/annotation/P.fragariae/Bc16/
Bc16_genes_incl_ORFeffectors.cdna.fasta          Bc16_genes_incl_ORFeffectors.exon.fasta          Bc16_genes_incl_ORFeffectors.gff3                Bc16_genes_incl_ORFeffectors.upstream3000.fasta  ORF_RxLR_parsed.gff3                             
Bc16_genes_incl_ORFeffectors.cds.fasta           Bc16_genes_incl_ORFeffectors.gene.fasta          Bc16_genes_incl_ORFeffectors.pep.fasta.gz        ORF_CRN_parsed.gff3                              
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ less gene_pred/annotation/P.fragariae/Bc16/^C
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ gunzip gene_pred/annotation/P.fragariae/Bc16/Bc16_genes_incl_ORFeffectors.pep.fasta.gz
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ less gene_pred/annotation/P.fragariae/Bc16/Bc16_genes_incl_ORFeffectors.pep.fasta
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r
There are several suitable screens on:
	8588.pts-16.bio72	(04/08/17 13:55:33)	(Attached)
	7487.pts-15.bio72	(04/08/17 13:50:28)	(Detached)
	18625.pts-16.bio72	(03/08/17 13:53:24)	(Detached)
	18538.pts-15.bio72	(03/08/17 13:53:11)	(Detached)
Type "screen [-d] -r [pid.]tty.host" to resume one of them.
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r 8
There is a screen on:
	8588.pts-16.bio72	(04/08/17 13:55:33)	(Attached)
There is no screen to be resumed matching 8.
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r 7
[detached from 7487.pts-15.bio72]
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ less report.txt
...
With EER:
strain: A4      species: P.fragariae
the number of SigP gene is:     74,332
...
strain: Bc1     species: P.fragariae
the number of SigP gene is:     75,009
...
strain: Bc23    species: P.fragariae
the number of SigP gene is:     73,930
...
strain: Nov27   species: P.fragariae
the number of SigP gene is:     74,317
...
strain: Nov5    species: P.fragariae
the number of SigP gene is:     74,198
the number of SigP-RxLR genes are:      2,362
the number of SigP-RxLR-EER genes are:  288
Merged RxLR-EER regex proteins: 260
...
strain: Nov71   species: P.fragariae
the number of SigP gene is:     74,421
...
strain: Nov77   species: P.fragariae
the number of SigP gene is:     74,413
...
strain: Nov9    species: P.fragariae
the number of SigP gene is:     75,084
...
strain: ONT3    species: P.fragariae
the number of SigP gene is:     80,829
the number of SigP-RxLR genes are:      2,483
the number of SigP-RxLR-EER genes are:  292
Merged RxLR-EER regex proteins: 263


strain: SCRP245_v2      species: P.fragariae
the number of SigP gene is:     77,920
the number of SigP-RxLR genes are:      2,346
the number of SigP-RxLR-EER genes are:  292
Merged RxLR-EER regex proteins: 264
...
[detached from 7487.pts-15.bio72]
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ less report.txt
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ rm report.txt
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ screen -r 7
[detached from 7487.pts-15.bio72]
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ less report.txt

Merged RxLR-EER regex proteins: 1928


strain: Nov9    species: P.fragariae
the number of SigP gene is:     75084
the number of SigP-RxLR genes are:      2394
the number of SigP-RxLR-EER genes are:  287
Merged RxLR-EER regex proteins: 1978


strain: ONT3    species: P.fragariae
the number of SigP gene is:     80829
the number of SigP-RxLR genes are:      2483
the number of SigP-RxLR-EER genes are:  292
Merged RxLR-EER regex proteins: 2032


strain: SCRP245_v2      species: P.fragariae
the number of SigP gene is:     77920
the number of SigP-RxLR genes are:      2346
the number of SigP-RxLR-EER genes are:  292
Merged RxLR-EER regex proteins: 1935
```
...
```
P.fragariae A4
Initial search space (Z):             74,332  [actual number of targets]
...
P.fragariae Bc1
Initial search space (Z):             75,009  [actual number of targets]
Domain search space  (domZ):             386  [number of targets reported over threshold]
P.fragariae Bc23
Initial search space (Z):             73,930  [actual number of targets]
Domain search space  (domZ):             395  [number of targets reported over threshold]
P.fragariae Nov27
Initial search space (Z):             74,317  [actual number of targets]
Domain search space  (domZ):             389  [number of targets reported over threshold]
P.fragariae Nov5
Initial search space (Z):             74,198  [actual number of targets]
Domain search space  (domZ):             386  [number of targets reported over threshold]
P.fragariae Nov71
Initial search space (Z):             74,421  [actual number of targets]
Domain search space  (domZ):             389  [number of targets reported over threshold]
P.fragariae Nov77
Initial search space (Z):             74,413  [actual number of targets]
Domain search space  (domZ):             362  [number of targets reported over threshold]
P.fragariae Nov9
Initial search space (Z):             75,084  [actual number of targets]
Domain search space  (domZ):             389  [number of targets reported over threshold]
P.fragariae ONT3
Initial search space (Z):             80,829  [actual number of targets]
Domain search space  (domZ):             395  [number of targets reported over threshold]
P.fragariae SCRP245_v2
Initial search space (Z):             77,920  [actual number of targets]
...
ONT3 done
SCRP245_v2 done
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$
  [Restored 4 Aug 2017, 16:01:23]
Last login: Fri Aug  4 13:36:07 on ttys001
Restored session: Fri  4 Aug 2017 16:01:17 BST
toms-macbook-3:~ adamst$ ssh cluster
adamst@149.155.34.72's password:
...
Debian GNU/Linux comes with ABSOLUTELY NO WARRANTY, to the extent
permitted by applicable law.
Last login: Fri Aug  4 16:01:43 2017 from toms-macbook-3.emr.ac.uk
adamst@bio72:~$ cd /home/groups/harrisonlab/project_files/phytophthora_fragariae/
adamst@bio72:/home/groups/harrisonlab/project_files/phytophthora_fragariae$ less report.txt
