...
do
    Organism=P.fragariae
    echo "$Organism - $Strain"
    if [ -f /home/groups/harrisonlab/project_files/phytophthora_fragariae/repeat_masked/$Organism/$Strain/ncbi_edits_repmask/*_unmasked_repeatmasker_TPSI_appended.fa ]
    then
        Assembly=$(ls /home/groups/harrisonlab/project_files/phytophthora_fragariae/repeat_masked/$Organism/$Strain/ncbi_edits_repmask/*_unmasked_repeatmasker_TPSI_appended.fa)
        echo $Assembly
    elif [ -f /home/groups/harrisonlab/project_files/phytophthora_fragariae/repeat_masked/$Organism/$Strain/deconseq_Paen_repmask/*_unmasked_repeatmasker_TPSI_appended.fa ]
    then
        Assembly=$(ls /home/groups/harrisonlab/project_files/phytophthora_fragariae/repeat_masked/$Organism/$Strain/deconseq_Paen_repmask/*_unmasked_repeatmasker_TPSI_appended.fa)
        echo $Assembly
    else
        Assembly=$(ls /home/groups/harrisonlab/project_files/phytophthora_fragariae/repeat_masked/quiver_results/polished/filtered_contigs_repmask/*_unmasked_repeatmasker_TPSI_appended.fa)
        echo $Assembly
    fi
...
the total number of SigP gene is:       11,021
the number of unique SigP gene is:      3,743
the number of SigP-RxLR genes are:      390
the number of SigP-RxLR-EER genes are:  190


strain: Bc16    species: P.fragariae
the total number of SigP gene is:       12,764
the number of unique SigP gene is:      4,270
the number of SigP-RxLR genes are:      460
the number of SigP-RxLR-EER genes are:  210


strain: Bc1     species: P.fragariae
the total number of SigP gene is:       11,163
the number of unique SigP gene is:      3,771
the number of SigP-RxLR genes are:      384
the number of SigP-RxLR-EER genes are:  192


strain: Bc23    species: P.fragariae
the total number of SigP gene is:       11,257
the number of unique SigP gene is:      3,796
the number of SigP-RxLR genes are:      385
the number of SigP-RxLR-EER genes are:  198


strain: Nov27   species: P.fragariae
the total number of SigP gene is:       11,072
...
```
P.fragariae A4
Initial search space (Z):             33,146  [actual number of targets]
Domain search space  (domZ):             187  [number of targets reported over threshold]
P.fragariae Bc16
Initial search space (Z):             36,250  [actual number of targets]
Domain search space  (domZ):             219  [number of targets reported over threshold]
P.fragariae Bc1
Initial search space (Z):             33,149  [actual number of targets]
Domain search space  (domZ):             190  [number of targets reported over threshold]
P.fragariae Bc23
Initial search space (Z):             32,727  [actual number of targets]
Domain search space  (domZ):             200  [number of targets reported over threshold]
P.fragariae Nov27
Initial search space (Z):             33,444  [actual number of targets]
Domain search space  (domZ):             187  [number of targets reported over threshold]
P.fragariae Nov5
Initial search space (Z):             33,429  [actual number of targets]
Domain search space  (domZ):             192  [number of targets reported over threshold]
P.fragariae Nov71
Initial search space (Z):             32,893  [actual number of targets]
Domain search space  (domZ):             189  [number of targets reported over threshold]
P.fragariae Nov77
Initial search space (Z):             33,452  [actual number of targets]
Domain search space  (domZ):             188  [number of targets reported over threshold]
P.fragariae Nov9
Initial search space (Z):             33,045  [actual number of targets]
Domain search space  (domZ):             188  [number of targets reported over threshold]
P.fragariae ONT3
Initial search space (Z):             36,854  [actual number of targets]
Domain search space  (domZ):             186  [number of targets reported over threshold]
P.fragariae SCRP245_v2
Initial search space (Z):             37,297  [actual number of targets]
