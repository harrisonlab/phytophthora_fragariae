...
do
    Organism=P.fragariae
    echo "$Organism - $Strain"
    if [ -f /home/groups/harrisonlab/project_files/phytophthora_fragariae/repeat_masked/$Organism/$Strain/manual_edits_repmask/*_unmasked.fa ]
    then
        Assembly=$(ls /home/groups/harrisonlab/project_files/phytophthora_fragariae/repeat_masked/$Organism/$Strain/manual_edits_repmask/*_unmasked.fa)
        echo $Assembly
...
the total number of SigP gene is:       10,779
the number of unique SigP gene is:      3,658
the number of SigP-RxLR genes are:      367
the number of SigP-RxLR-EER genes are:  178


strain: SCRP245_v2      species: P.fragariae
the total number of SigP gene is:       10,642
the number of unique SigP gene is:      3,581
the number of SigP-RxLR genes are:      370
...
Merged RxLR regex proteins: 2,172
...
the number of SigP-RxLR-EER genes are:  298
Merged RxLR regex proteins: 2,031
Merged RxLR-EER regex proteins: 269
...
Initial search space (Z):            655,156  [actual number of targets]
...
Initial search space (Z):            645,061  [actual number of targets]
...
```bash
for file in $(ls gene_pred/annotation/P.fragariae/*/*effectors_renamed.pep.fasta)
do
    Strain=$(echo $file | rev | cut -f2 -d "/" | rev)
