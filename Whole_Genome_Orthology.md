...
# Orthology groups containing TFs/TRs were identified using the following commands:
...
do
    ...
    echo "The following TFs were found in Race 2 unique orthogroups:"
...
These were distributed through the following number of Orthogroups:
217
The following TFs were found in Race 2 unique orthogroups:
0
...
for num in 1
do
    TF_UK2_uniq=$TF_Dir/UK2_unique_TFs.txt
    cat $TF_ID | grep -v -w -f $TF_Orthogroup_hits > $TF_UK2_uniq
    echo "The number of UK2 unique TFs are:"
    cat $TF_UK2_uniq | wc -l
    TF_Seq_Bc16=analysis/transcription_factors/P.fragariae/Bc16/greedy/Bc16_TF_TR_hmmer.fa
    TF_Seq_A4=analysis/transcription_factors/P.fragariae/A4/greedy/A4_TF_TR_hmmer.fa
    Final_genes_Bc16=gene_pred/annotation/P.fragariae/Bc16/Bc16_genes_incl_ORFeffectors.pep.fasta
    Final_genes_A4=gene_pred/annotation/P.fragariae/A4/A4_genes_incl_ORFeffectors.pep.fasta
...
do
    ProgDir=/home/adamst/git_repos/tools/pathogen/orthology/orthoMCL
    OrthogroupTxt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK2_TFs/UK2_TF_Orthogroups.txt
    GoodProt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/goodProteins/goodProteins.fasta
    OutDir=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK2_TFs/orthogroups_fasta_UK2_TF
    mkdir -p $OutDir
    $ProgDir/orthoMCLgroups2fasta.py --orthogroups $OrthogroupTxt --fasta $GoodProt --out_dir $OutDir
done
```
...
do
    ProgDir=/home/adamst/git_repos/tools/pathogen/orthology/orthoMCL
    OrthogroupTxt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK2_TFs/Pf_TF_Orthogroups_hits.txt
    GoodProt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/goodProteins/goodProteins.fasta
    OutDir=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK2_TFs/orthogroups_fasta_Pf_TF
    mkdir -p $OutDir
    $ProgDir/orthoMCLgroups2fasta.py --orthogroups $OrthogroupTxt --fasta $GoodProt --out_dir $OutDir
done
```
...
# Race 1 unique Transcription factor or Transcriptional regulators orthogroups

# Race 1 TF genes were parsed to the same format as the gene names used in the analysis:
...
do
    ...
    TF_Seq_Bc1=analysis/transcription_factors/P.fragariae/Bc1/greedy/Bc1_TF_TR_hmmer.fa
    TF_Seq_Nov5=analysis/transcription_factors/P.fragariae/Nov5/greedy/Nov5_TF_TR_hmmer.fa
    Final_genes_Bc1=gene_pred/annotation/P.fragariae/Bc1/Bc1_genes_incl_ORFeffectors.pep.fasta
    Final_genes_Nov5=gene_pred/annotation/P.fragariae/Nov5/Nov5_genes_incl_ORFeffectors.pep.fasta
...
do
    ProgDir=/home/adamst/git_repos/tools/pathogen/orthology/orthoMCL
    OrthogroupTxt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK1_TFs/UK1_TF_Orthogroups.txt
    GoodProt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/goodProteins/goodProteins.fasta
    OutDir=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK1_TFs/orthogroups_fasta_UK1_TF
    mkdir -p $OutDir
    $ProgDir/orthoMCLgroups2fasta.py --orthogroups $OrthogroupTxt --fasta $GoodProt --out_dir $OutDir
done
```
...
## Extracting fasta files for P. fragariae orthogroups containing Race 1 putative TF/TRs

```bash
for num in 1
do
    ProgDir=/home/adamst/git_repos/tools/pathogen/orthology/orthoMCL
    OrthogroupTxt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK1_TFs/Pf_TF_Orthogroups_hits.txt
    GoodProt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/goodProteins/goodProteins.fasta
    OutDir=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK1_TFs/orthogroups_fasta_Pf_TF
    mkdir -p $OutDir
    $ProgDir/orthoMCLgroups2fasta.py --orthogroups $OrthogroupTxt --fasta $GoodProt --out_dir $OutDir
done
```
...
# Ortholog groups containing TF/TR proteins were identified using the following commands:
...
These were distributed through the following number of Orthogroups:
219
The following TFs were found in Race 3 unique orthogroups:
0
These orthogroups contain the following number of TFs:
0
The following TFs were found in P.fragariae unique orthogroups:
...
# The Race 3 TF/TR genes that were not found in orthogroups were identified:
...
do
    ...
    TF_Seq_Nov27=analysis/transcription_factors/P.fragariae/Nov27/greedy/Nov27_TF_TR_hmmer.fa
    TF_Seq_Nov71=analysis/transcription_factors/P.fragariae/Nov71/greedy/Nov71_TF_TR_hmmer.fa
    TF_Seq_Nov9=analysis/transcription_factors/P.fragariae/Nov9/greedy/Nov9_TF_TR_hmmer.fa
    Final_genes_Nov27=gene_pred/annotation/P.fragariae/Nov27/Nov27_genes_incl_ORFeffectors.pep.fasta
    Final_genes_Nov71=gene_pred/annotation/P.fragariae/Nov71/Nov71_genes_incl_ORFeffectors.pep.fasta
    Final_genes_Nov9=gene_pred/annotation/P.fragariae/Nov9/Nov9_genes_incl_ORFeffectors.pep.fasta
...
do
    ProgDir=/home/adamst/git_repos/tools/pathogen/orthology/orthoMCL
    OrthogroupTxt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK3_TF/UK3_TF_Orthogroups.txt
    GoodProt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/goodProteins/goodProteins.fasta
    OutDir=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK3_TFs/orthogroups_fasta_UK3_TF
    mkdir -p $OutDir
    $ProgDir/orthoMCLgroups2fasta.py --orthogroups $OrthogroupTxt --fasta $GoodProt --out_dir $OutDir
done
```
...
## Extracting fasta files for P. fragariae orthogroups containing Race 3 putative TF/TRs

```bash
for num in 1
do
    ProgDir=/home/adamst/git_repos/tools/pathogen/orthology/orthoMCL
    OrthogroupTxt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK3_TFs/Pf_TF_Orthogroups_hits.txt
    GoodProt=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/goodProteins/goodProteins.fasta
    OutDir=analysis/orthology/orthomcl/All_Strains_plus_rubi_no_removal/UK3_TFs/orthogroups_fasta_Pf_TF
    mkdir -p $OutDir
    $ProgDir/orthoMCLgroups2fasta.py --orthogroups $OrthogroupTxt --fasta $GoodProt --out_dir $OutDir
done
```
